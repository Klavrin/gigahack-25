            ...
            <SidebarGroupContent className="space-y-2">
              <SidebarMenu>
                <SidebarMenuItem className="mb-6">
                  ...
                  >
                    <Button
                      className="w-full h-12 bg-emerald-600 active:scale-[0.98] text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 border-0"
